...
3. Check differential insertion loss across the required signal bandwidth.
...
Real chokes have leakage inductance and capacitance. They can attenuate or distort the wanted signal. Current imbalance can also reduce the available magnetic margin.
...
1. The common-mode voltage is **2.5 V**.
...
A real receiver has finite common-mode rejection and a limited input range. Equal interference can still cause a failure.
