...
Extract every file into one folder. Open jfet-output-curves.asc and select Run.
Use View > Step Legend to identify parameter steps.
If no plot appears, open jfet-output-curves.plt through Plot Settings > Open Plot Settings File.
